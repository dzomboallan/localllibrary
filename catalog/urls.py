...
urlpatterns = [
    ...
    path(
        'book/<int:pk>', views.BookDetailView.as_view(), name='book-detail'),
    path(
        'authors/', views.AuthorListView.as_view(), name='authors'),
    path(
        'author/<int:pk>',
    ...
    path(
        'author/create/', views.AuthorCreate.as_view(), name='author-create'),
    path(
    ...
    path(
        ...
        name='author-delete'),
    path(
        'book/create/', views.BookCreate.as_view(), name='book-create'),
    path(
        'book/<int:pk>/update/',
