    ...
    def setUp(self):
        ...
        def test_form_invalid_renewal_date_past(self):
            ...
            self.assertFormError(response.context['form'],
                                 'renewal_date', 'Invalid date - renewal in past')
...
class AuthorCreateViewTest(TestCase):
    def setUp(self):
        ...
        permAddBook = Permission.objects.get(
            codename='add_book', content_type=content_typeBook,)

        content_typeAuthor = ContentType.objects.get_for_model(Author)
        permAddAuthor = Permission.objects.get(
            codename="add_author",content_type=content_typeAuthor,)
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        expected_initial_date = datetime.date(2024, 11, 11)
